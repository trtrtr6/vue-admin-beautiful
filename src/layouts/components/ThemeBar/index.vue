...
export default {
  ...
  data() {
    return {
      ...
      theme: {
        ...
        buttonBackground: variables.buttonBackground,
        paginationActiveBackground: variables.paginationActiveBackground,
      },
    };
  },
  computed: {
  ...
  methods: {
    ...
    handleSetTheme() {
      ...
      let buttonBackground = this.theme.buttonBackground;
      let paginationActiveBackground = this.theme.paginationActiveBackground;
